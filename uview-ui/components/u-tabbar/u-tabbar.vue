<template>
	...
	>
		<view
		    ...
		    :style="[{
				height: $u.addUnit($u.getPx(height) + $u.sys().safeAreaInsets.bottom),
				backgroundColor: bgColor,
				paddingBottom: $u.addUnit($u.sys().safeAreaInsets.bottom)
			}, $u.addStyle(customStyle)]"
		    :class="[borderTop && 'u-border-top']"
		>
			<view
				...
				v-if="!item.midButton"
			>
				<view :class="['u-tabbar__content__item__icon']">
					<u-icon
				...
				<text
				    class="u-tabbar__content__item__text u-line-1"
				    :style="{
						color: elColor(index)
					}"
				>{{item.text}}</text>
				...
				>
					<text class="u-line-1 u-tabbar__content__item__text__text">{{item.text}}</text>
				</view> -->
			</view>
		</view>
		<view
		    v-if="midButton"
		    class="u-tabbar__circle-border"
		>
		</view>
